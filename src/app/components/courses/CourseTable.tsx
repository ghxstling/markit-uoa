                    ...
                    <Table style={{paddingTop:40}}>
                        <TableHead>
                            <TableRow>
                                ...
                                <TableCell style={{textAlign:'center'}}><div style={{alignItems: 'center', flexWrap: 'wrap',}}>Edit Course Details</div></TableCell>
                                ...
                                <TableCell style={{textAlign:'center'}}><div style={{alignItems: 'center', flexWrap: 'wrap',}}>Status <Tooltip title="status"><InfoOutlinedIcon style={{marginLeft:5, verticalAlign:"middle"}}/></Tooltip></div></TableCell>
                            </TableRow>
                        </TableHead>
                        <TableBody>
                          {(rowsPerPage > 0
